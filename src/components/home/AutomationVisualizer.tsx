  ...
  return (
    <div className="p-8 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-sm relative max-w-2xl">
      ...
      <div className="relative flex flex-col items-center animate-blob">
        ...
        <div className="relative h-12 w-[2px] bg-white/10 my-2">
          <div className="absolute top-0 left-0 w-full h-1/3 bg-gradient-to-b from-transparent via-brand-orange to-transparent animate-beam-down opacity-70" style={{ animationDelay: '1s' }}></div>
        </div>

        {/* Module 3 - AI Automation */}
        <div className="w-full p-4 rounded-xl bg-brand-orange/10 border border-brand-orange/20 flex items-center gap-4 group hover:bg-brand-orange/15 transition-all duration-300">
          <div className="flex-shrink-0 w-12 h-12 rounded-lg bg-brand-orange/20 border border-brand-orange/30 flex items-center justify-center">
            <Cpu className="w-6 h-6 text-brand-orange animate-pulse" style={{ animationDuration: '3s', animationDelay: '2s' }} />
          </div>
          <div className="flex-1">
            <h4 className="text-base font-ubuntu font-bold text-white">AI Automation</h4>
          </div>
          <div className="px-3 py-1 bg-brand-orange/20 border border-brand-orange/30 rounded-full">
        ...
        <div className="absolute -bottom-4 left-1/4 w-2 h-2 bg-brand-orange rounded-full animate-ping opacity-30" style={{ animationDelay: '2s' }}></div>
      </div>
    </div>
  );
};
