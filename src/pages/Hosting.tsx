...
const included = [
  { icon: Globe,       title: 'Domain Registration', desc: 'We handle the purchase, transfer and DNS' },
...
const forYouIf = [
  "You've got a website but no idea who manages the hosting or domain",
  "You're using a Gmail address for your business and it looks unprofessional",
  "You want one team handling everything so nothing falls through the cracks",
];

const faqs = [
  {
    q: "What's included in monthly maintenance?",
    a: 'Security patches, plugin/dependency updates, uptime monitoring, weekly backups, and priority support. You never have to think about it.',
  },
  {
    q: 'Can you take over my existing hosting?',
    a: 'Yes. We migrate your site to our managed infrastructure, handle the DNS transfer and make sure nothing goes down during the move.',
  },
  {
    q: 'How much does hosting cost per month?',
    a: 'Depends on your stack and needs. Ranges from R250–R699/month for standard hosting. We quote after the strategy call.',
  },
  {
    q: 'Do you support custom domain emails?',
    a: 'Yes. We set up professional email (e.g. yourname@yourbusiness.com) via Google Workspace or Zoho, depending on your preference.',
  },
];
  ...
  return (
    <div className="relative overflow-hidden">
      <SEO
        ...
        description="Domain registration, professional email, SSL and monthly maintenance for SA businesses. Your digital foundation. Locked in and looked after."
      />
      ...
      <section className="relative min-h-[80vh] flex items-center py-24 overflow-hidden noise-overlay">
        <div
          ...
          style={{ background: 'radial-gradient(ellipse at top, rgba(119,76,252,0.15), transparent 70%)' }}
        />
        <div
          className="absolute bottom-0 left-0 w-[500px] h-[400px] pointer-events-none"
          style={{ background: 'radial-gradient(ellipse at bottom left, rgba(242,106,61,0.08), transparent 70%)' }}
        />
          ...
          <motion.div initial="hidden" animate="visible" variants={springStagger}>
            ...
            <motion.div custom={2} variants={heroTextReveal}>
              <span
                ...
                style={{ fontSize: 'clamp(48px, 8vw, 100px)' }}
              >
                Locked in. Looked after.
              </span>
            </motion.div>
            <motion.p custom={3} variants={heroTextReveal} className="text-white/60 max-w-[500px] mb-10 text-base leading-relaxed">
              Domain, professional email, SSL, DNS and monthly maintenance.
              Everything so you never have to think about the technical side again.
            </motion.p>
      ...
      <section className="section">
        <div className="container">
          ...
          <h2 className="h2 text-center mb-12">
            Everything managed. <GradientText>Nothing missed.</GradientText>
          </h2>
          <motion.div
      ...
      <section className="section">
        <div className="container max-w-3xl">
          ...
          <h2 className="h2 mb-10">
            Domain, email, SSL + <GradientText>ongoing care.</GradientText>
          </h2>
          <motion.div
                ...
                <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl overflow-hidden hover:border-white/20 transition-all duration-300">
                  ...
                  <div className="p-6 flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-white/50 text-sm">Domain + professional email + SSL + monthly maintenance retainer</p>
                    </div>
