      ...
      <section className="s">
        <div className="container">
          ...
          >
            ...
            {/* Subtext */}
            <motion.p variants={fadeUp} className="body-text-bright text-center max-w-xl mx-auto mt-4">
          ...
          >
            ...
            <motion.div variants={cardItem} className="card card-bar card-bar-white card-h">
              ...
              <div className="p-6">
                ...
                <p className="body-text mt-1">A clean, professional website live in 3–5 days.</p>
            ...
            <motion.div variants={cardItem} className="card card-featured">
              {/* Most Popular Badge */}
              ...
              <div className="p-6">
                ...
                <p className="body-text mt-1">Automated leads, bookings, and follow-ups.</p>
                <p className="price text-orange mt-4">From R15,000</p>
                
                <ul className="mt-4 space-y-2">
                  {['Booking system + AI chatbot', 'WhatsApp & email alerts', 'Delivered in 5–7 days'].map((item, i) => (
                    <li key={i} className="flex items-center gap-2 body-text">
                      <Check className="w-4 h-4 text-orange" /> {item}
                    </li>
                  ))}
                </ul>
            ...
            <motion.div variants={cardItem} className="card card-bar card-bar-purple card-h-purple">
              ...
              <div className="p-6">
                ...
                <p className="body-text mt-1">A long-term growth partner.</p>
                <p className="price text-purple mt-4">From R30,000</p>
                
                <ul className="mt-4 space-y-2">
                  {['Analytics dashboard', 'Advanced automations', 'Monthly optimisation'].map((item, i) => (
                    <li key={i} className="flex items-center gap-2 body-text">
                      <Check className="w-4 h-4 text-purple" /> {item}
                    </li>
                  ))}
                </ul>
                ...
                <Link
                  ...
                  className="btn btn-purple w-full mt-6"
                >
                  Learn More →
                </Link>
              </div>
        ...
        <div className="container">
          ...
          >
            <motion.div variants={cardItem} className="card">
              <div className="stat-number text-purple">&lt;7</div>
              <div className="stat-label">Days Delivery</div>
            </motion.div>
            <motion.div variants={cardItem} className="card">
              <div className="stat-number text-orange">3</div>
              <div className="stat-label">Core Packages</div>
            </motion.div>
            <motion.div variants={cardItem} className="card">
              <div className="stat-number text-purple">R6.5K</div>
              <div className="stat-label">Starting From</div>
            </motion.div>
            <motion.div variants={cardItem} className="card">
              <div className="stat-number text-orange">100%</div>
      ...
      <section className="s s-panel s-line-purple">
        <div className="container">
          ...
          >
            ...
            <motion.p variants={fadeUp} className="body-text mt-2">
              Extend any package with add-ons.
            </motion.p>

            {/* Teaser Tiles */}
            <motion.div variants={fadeUp} className="grid grid-cols-2 md:grid-cols-4 gap-3 max-w-2xl mx-auto mt-8">
              {[
                ...
                <div key={i} className="card card-sm card-bar card-bar-purple card-h-purple">
                  <div className="flex items-center justify-center gap-2">
                    <span className="text-purple">{item.icon}</span>
            ...
            <motion.div variants={fadeUp} className="mt-8">
              <Link to="/add-ons" className="text-orange hover:text-orange-300 underline-offset-4 hover:underline transition">
