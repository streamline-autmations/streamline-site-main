...
/**
 * HomeV2 — comparison build of the homepage, identical to Home except it
 * uses the older laptop-zoom canvas hero (HeroVideoScroll) instead of
 * HeroBuilderScroll, so Christiaan can compare the two heroes live at
 * /home-v2. Not linked from nav — direct URL only.
 */
