'use client'; // Next.js — remove this line if using Vite/React without App Router
...
/*
───────────────────────────────────────────────
  HOW TO USE IN YOUR NEXT.JS / VITE SITE
───────────────────────────────────────────────

1. Copy this file to: src/components/InteractiveDotGrid.tsx

2. In your root layout (Next.js: app/layout.tsx, Vite: App.tsx):
     ...
     return (
       <html lang="en">
         <body className="bg-[#050507] text-white">
           <InteractiveDotGrid />                   // sits at z-0
           <div className="relative z-10">          // all content above
             {children}
           </div>
         </body>
       </html>
...
3. Remove your old background component entirely.

4. Adjust CFG at the top of this file to change:
   - dotGap / dotRadius — density and size
   - dotBaseAlpha / dotLitAlpha — subtlety of the effect
   - litRadius — how far the glow reaches
   - blobs[].color — change purple/orange to any RGB
   - blobs[].alpha — glow intensity
   - blobs[].r — glow blob size
